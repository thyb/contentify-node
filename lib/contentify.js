...
Content = (function() {
  ...
  Content.prototype.initialize = function(owner, repo, username, password, mode) {
    this.owner = owner;
    this.repo = repo;
  ...
  Content.prototype.clearCache = function(filename) {
    if (filename) {
  ...
  Content.prototype.compile = function(data) {
    var fragment, match, r, regexp, res, results, _i, _len;
  ...
  Content.prototype.getFragments = function(filename, callback) {
    if (!filename) {
    ...
    if (this.content[filename]) {
      ...
      return this.getContentRaw(filename, (function(_this) {
        return function(err, data) {
          ...
          comp = _this.compile(data);
          _this.content[filename] = comp;
